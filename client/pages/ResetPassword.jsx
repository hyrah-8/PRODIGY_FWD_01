...
const ResetPassword = () => {
  const { backendUrl } = useContext(AppContent); // ✅ Fixed variable name
  ...
  const handlePaste = (e) => {
    ...
    setOtp(pasteArray.join("")); // Store pasted OTP in state
  };
  ...
  const onSubmitNewPassword = async (e) => {
    ...
    try {
      const { data } = await axios.post(backendUrl + "/api/auth/reset-password", {
        ...
        data.success ? toast.success(data.message): toast.e(data.message)
