...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800 text-lg sm:text-xl'>
      ...
      <p className='mb-8 max-w-md'>let's start with a quick prodct tour and we will have you up and running in no time!</p>
